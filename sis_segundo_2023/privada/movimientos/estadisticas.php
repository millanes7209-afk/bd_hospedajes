            ...
            <div class="col-12">
                ...
                <div class="row mb-4">
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card card-ingresos shadow-sm border-0 h-100 stat-card-total">
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card card-egresos shadow-sm border-0 h-100 stat-card-total">
                            <div class="card-body py-3 text-center">
                    ...
                    <div class="col-md-4">
                        <div class="card card-neto shadow-sm border-0 h-100 stat-card-total">
                            <div class="card-body py-3 text-center">
