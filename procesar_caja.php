...
if (isset($_POST['accion'])) {
    ...
    if ($accion === 'abrir') {
        ...
        $sql_cerrar_caja = "UPDATE cajas 
            SET fecha_cierre = ?, estado = 'CERRADA', _fec_modificacion = ?
            WHERE cajaID = ? AND usuarioID = ? AND empresaID = ?";
        $result = $db->ejecutar($sql_cerrar_caja, array($fecha_cierre, $fecha_cierre, $caja_abierta_id, $usuarioID, $empresaID));
