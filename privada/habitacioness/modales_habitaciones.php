      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="descripcion" placeholder="Ej: Baño simple"
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="descripcion" placeholder="Ej: Pago de luz"
              oninput="this.value = this.value.toUpperCase()">
          </div>
          <div class="mb-3">
      ...
      <div class="modal-body">
        <form id="form-momentaneo" action="registrar_momentaneo.php" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" name="monto_total" id="mom-monto_total" step="0.5" min="1"
              required placeholder="0.00" oninput="actualizarResumenMom()">
          </div>
          ...
          <div class="card border-primary shadow-sm mb-3">
            <div class="card-header py-1 d-flex justify-content-between align-items-center">
              ...
              <button type="button" class="btn btn-xs btn-light py-0 px-1" onclick="agregarFilaPagoMom()"
            ...
            <div class="card-body p-2">
              ...
              <div class="border-top mt-2 pt-1">
                ...
                <div id="momAlertaSaldo" class="alert alert-danger py-1 px-2 small mb-0 text-center fw-bold"
...
<!-- Modal Mantenimiento -->
<div class="modal fade" id="modal-mantenimiento" tabindex="-1" aria-labelledby="modalmantenimientolabel"
  aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <form id="form-mantenimiento" action="registrar_mantenimiento.php" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="mantenimiento-descripcion" name="descripcion"
...
<div class="modal fade" id="modal-cambio-habitacion" tabindex="-1" aria-labelledby="modal-cambio-label"
  aria-hidden="true">
  <div class="modal-dialog">
    <form action="cambiar_habitacion.php" method="post">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-success" id="btn-ejecutar-cambio" disabled><i class="fas fa-check"></i>
...
<div class="modal fade" id="modal-eliminar-hospedaje" tabindex="-1" aria-labelledby="modal-eliminar-label"
  aria-hidden="true">
  <div class="modal-dialog">
    <form action="eliminar_hospedaje.php" method="post">
      <div class="modal-content">
        <div class="modal-header bg-danger text-white">
          <h5 class="modal-title" id="modal-eliminar-label"><i class="fas fa-trash-alt"></i> Eliminar Registro de
            Hospedaje</h5>
          <button type="button" class="close text-white" data-bs-dismiss="modal"
            style="border:none; background:none; font-size: 1.5rem; line-height: 1;">&times;</button>
        </div>
        <div class="modal-body text-center">
          ...
          <p class="lead">Se eliminará el hospedaje de la <strong>Habitación <span
                id="eliminar-numero-hab"></span></strong>.</p>
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" name="motivo" rows="2"
              placeholder="Explique brevemente por qué se elimina este hospedaje..." required
      ...
      <div class="modal-content shadow-sm">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" name="monto_total" id="pago-deuda-monto_total" min="0" step="0.5"
              required>
          </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="mb-3">
            ...
            <input type="number" class="form-control form-control-lg text-center fw-bold" name="monto" value="1"
              step="0.5" required>
          </div>
