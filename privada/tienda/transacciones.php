    ...
    <div class="card-body">
        <form id="filterForm" class="row g-2 align-items-end mb-3">
            ...
            <div class="col-md-3">
                ...
                <input type="date" class="form-control form-control-sm" id="filtroDesde" value="<?= date('Y-m-d') ?>">
            </div>
            <div class="col-md-3">
                <label class="small fw-bold">Hasta:</label>
                <input type="date" class="form-control form-control-sm" id="filtroHasta" value="<?= date('Y-m-d') ?>">
            </div>
            <div class="col-md-3">
