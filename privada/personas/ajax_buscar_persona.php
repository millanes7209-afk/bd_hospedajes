    ...
    if ($rs3) {
        ...
        foreach ($rs3 as $k => $fila) {
            ...
            echo "<tr>
                    ...
                    <td>
                        <form name='formModif".$fila["id_persona"]."' method='post' action='persona_modificar.php' style='display:inline;'>
                    ...
                    <td>
                        <form name='formElimi".$fila["id_persona"]."' method='post' action='persona_eliminar.php' style='display:inline;'>
                            <input type='hidden' name='id_persona' value='".$fila["id_persona"]."'>
                            <button type='submit' class='btn btn-sm btn-danger btn-accion' onclick='return confirm(\"Desea realmente eliminar a la persona ".$fila["nombres"]." ".$fila["ap"]." ".$fila["am"]." ?\");'>Eliminar</button>
                        </form>
                    </td>
                  </tr>";
        }
