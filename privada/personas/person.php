        ...
        echo"<center>
            ...
            foreach ($rs as $k => $fila) {                                       
                echo"<tr>
                        ...
                        <td>".$fila['nombres']."</td>
                        <td align='center'>
                          <form name='formModif".$fila["empleadoID"]."' method='post' action='persona_modificar.php'>
                            <input type='hidden' name='empleadoID' value='".$fila['empleadoID']."'>
                            <a href='javascript:document.formModif".$fila['empleadoID'].".submit();' title='Modificar Persona Sistema'>
                              Modificar>>
                            </a>
                          </form>
                        </td>
                        <td align='center'>  
                          <form name='formElimi".$fila["empleadoID"]."' method='post' action='persona_eliminar.php'>
                            <input type='hidden' name='empleadoID' value='".$fila["empleadoID"]."'>
                            <a href='javascript:document.formElimi".$fila['empleadoID'].".submit();' title='Eliminar Persona Sistema' 
