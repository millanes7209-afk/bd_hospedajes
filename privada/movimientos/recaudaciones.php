    ...
    <div class="container-fluid mt-4" id="area-impresion">
        ...
        <div class="card shadow-sm border-0">
            <div class="card-header d-flex justify-content-between align-items-center py-3">
                ...
                <button onclick="window.print()" class="btn btn-outline-dark btn-sm"><i class="fas fa-print"></i>
                    ...
                    <table class="table table-hover table-striped tabla-turno border-bottom mb-0">
                        ...
                        <tbody>
                            <?php if (!$recaudaciones): ?>
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-4">No hay registros de recaudación en
                                        este rango.</td>
                                </tr>
                            <?php endif; ?>
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle"
                                        ...
                                        <button class="btn btn-sm btn-outline-secondary border-0"
                                            onclick="verDetalleRecaudacion(<?= $r['recaudacionID'] ?>)"
                                            title="Ver Detalles">
                        ...
                        <?php if ($recaudaciones): ?>
                            <tfoot class="bg-light border-top">
                                <tr>
                                    <th colspan="5" class="text-right align-middle text-muted" style="text-align: right;">
