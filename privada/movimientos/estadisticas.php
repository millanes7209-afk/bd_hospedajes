                ...
                <div class="col-md-4">
                    <div class="card stat-card border-start border-success border-4">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div>
                                <h6 class="text-muted mb-1 text-uppercase small fw-bold">Total Ingresos</h6>
                                <h2 class="mb-0 fw-bold" id="total-ingresos">Bs. 0.00</h2>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card stat-card border-start border-danger border-4">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div>
                                <h6 class="text-muted mb-1 text-uppercase small fw-bold">Total Gastos</h6>
                                <h2 class="mb-0 fw-bold" id="total-egresos">Bs. 0.00</h2>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card stat-card border-start border-primary border-4">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div>
                                <h6 class="text-muted mb-1 text-uppercase small fw-bold">Balance Neto</h6>
                                <h2 class="mb-0 fw-bold" id="total-neto">Bs. 0.00</h2>
                            </div>
                        </div>
                    </div>
                </div>
