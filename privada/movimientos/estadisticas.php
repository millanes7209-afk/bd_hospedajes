    ...
    <div class="container-fluid mt-4 mb-5">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="card stat-card">
                    <div class="card-body py-3 d-flex flex-wrap justify-content-between align-items-center">
                        <h4 class="mb-0 fw-bold text-dark"><i class="fas fa-chart-line me-2 text-primary"></i> PANEL DE
                            ESTADÍSTICAS</h4>
                        <div class="d-flex align-items-center gap-2">
                            <button class="btn btn-sm btn-outline-secondary" onclick="setRango('7dias')">Últimos 7
                                días</button>
                            <button class="btn btn-sm btn-outline-secondary" onclick="setRango('mes')">Mes
                                Actual</button>
                            <button class="btn btn-sm btn-outline-secondary" onclick="setRango('anio')">Año
                                Actual</button>

                            <input type="date" id="fecha_inicio" class="form-control form-control-sm ms-3"
                                style="width: 140px;">
                            <span class="text-muted">al</span>
                            <input type="date" id="fecha_fin" class="form-control form-control-sm"
                                style="width: 140px;">
                            <button class="btn btn-sm btn-primary" onclick="cargarEstadisticas()"><i
                ...
                <div class="row mb-4">
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card bg-success text-white shadow-sm border-0 h-100 stat-card-total">
                            <div class="card-body py-3 text-center">
                                <h6 class="text-uppercase small fw-bold opacity-75 mb-1">Total Ingresos</h6>
                                <h3 class="mb-0 fw-bold" id="total-ingresos">Bs. 0.00</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card bg-danger text-white shadow-sm border-0 h-100 stat-card-total">
                            <div class="card-body py-3 text-center">
                                <h6 class="text-uppercase small fw-bold opacity-75 mb-1">Total Gastos</h6>
                                <h3 class="mb-0 fw-bold" id="total-egresos">Bs. 0.00</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card bg-primary text-white shadow-sm border-0 h-100 stat-card-total">
                            <div class="card-body py-3 text-center">
                                <h6 class="text-uppercase small fw-bold opacity-75 mb-1">Balance Neto</h6>
                                <h3 class="mb-0 fw-bold" id="total-neto">Bs. 0.00</h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card stat-card">
                            <div class="stat-header"><i class="fas fa-wallet me-2"></i> Flujo de Ingresos vs Gastos
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-lg-4">
                        <div class="card stat-card h-100">
                            <div class="stat-header d-flex justify-content-between align-items-center">
                                ...
                                <ul class="nav nav-pills card-header-pills" style="font-size: 0.85rem;"
                                    id="categoria-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active py-1 px-2" id="btn-cat-in" href="#"
                                            onclick="renderCategorias('in'); return false;">Ingresos</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link py-1 px-2" id="btn-cat-out" href="#"
                                            onclick="renderCategorias('out'); return false;">Egresos</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="card-body d-flex justify-content-center">
                ...
                <div class="row">
                        ...
                        <div class="card stat-card h-100">
                            <div class="stat-header d-flex justify-content-between align-items-center">
                                ...
                                <ul class="nav nav-pills card-header-pills" style="font-size: 0.85rem;"
                                    id="procedencia-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active py-1 px-2" id="btn-depto" href="#"
                                            onclick="renderProcedencia('depto'); return false;">Dptos.</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link py-1 px-2" id="btn-pais" href="#"
                                            onclick="renderProcedencia('pais'); return false;">País</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="card-body d-flex justify-content-center">
                    ...
                    <div class="col-lg-4">
                        <div class="card stat-card h-100">
                            <div class="stat-header"><i class="fas fa-star me-2 text-warning"></i> Top Clientes
                                Frecuentes
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card stat-card h-100">
                            <div class="stat-header"><i class="fas fa-user-tie me-2 text-primary"></i> Productividad
                                Personal</div>
                            <div class="card-body p-0">
                                <div class="table-responsive">
            ...
            <script>
                ...
                function cargarEstadisticas() {
                    ...
                    fetch(`ajax_estadisticas.php?inicio=${f_ini}&fin=${f_fin}`)
                        ...
                        .then(data => {
                            ...
                            actualizarResumenTotales(data.finanzas);
                ...
                // 1.5 Actualizar Tarjetas de Resumen
                function actualizarResumenTotales(datos) {
                    let ingresos = 0;
                    let egresos = 0;

                    datos.forEach(d => {
                        if (d.tipo === 'INGRESO') ingresos += parseFloat(d.total);
                        else if (d.tipo === 'EGRESO') egresos += parseFloat(d.total);
                    });

                    const neto = ingresos - egresos;

                    document.getElementById('total-ingresos').innerText = 'Bs. ' + ingresos.toLocaleString('es-BO', { minimumFractionDigits: 2 });
                    document.getElementById('total-egresos').innerText = 'Bs. ' + egresos.toLocaleString('es-BO', { minimumFractionDigits: 2 });
                    document.getElementById('total-neto').innerText = 'Bs. ' + neto.toLocaleString('es-BO', { minimumFractionDigits: 2 });
                }
