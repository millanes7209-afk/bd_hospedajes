...
function mostrarDetalles(fecha, usuarioID) {
    ...
    xhr.onload = function() {
        if (xhr.status == 200) {
            ...
            var detallesHTML = '<table class="table table-bordered"><thead><tr><th>Descripción</th><th>Monto</th><th>Tipo</th></tr></thead><tbody>';
            
            detalles.forEach(function(detalle) {
                var filaClass = (detalle.tipo.toUpperCase() === 'EGRESO') ? ' class="egreso"' : '';
                detallesHTML += '<tr' + filaClass + '><td>' + detalle.descripcion + '</td><td>' + detalle.monto + '</td><td>' + detalle.tipo + '</td></tr>';
            });
