                        ...
                        <form action="procesar_permanencia.php" method="post" id="formHospedaje"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 ps-md-4">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label for="checkout" class="form-label"><b>(*) NUEVA SALIDA</b> <small
                                                    class="text-muted ms-2">(Venció:
                                                    <?php echo date('d/m/Y H:i', strtotime($checkout_anterior)); ?>)</small></label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="monto_total" class="form-label"><b>(*) Monto a Cobrar
                                                    (Bs)</b></label>
                                            <input type="number" class="form-control" name="monto_total"
                                                id="monto_total" value="<?php echo $monto_defecto; ?>" min="0"
                                                step="0.5" required oninput="actualizarResumenPagos()"
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" name="descripcion" id="descripcion" rows="2"
                                                placeholder="Ej: Extensión de un día extra..."
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (form) {
                form.addEventListener('submit', function (event) {
                    ...
                    // 1. VALIDACIÓN NATIVA (CAMPOS VACÍOS)
