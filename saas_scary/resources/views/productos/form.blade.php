  ...
  <header class="glass-card mb-6 p-4 border-b rounded-none" style="border-color:var(--color-card-border);background:var(--color-bg-alt)">
      <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div class="flex items-center gap-3">
              ...
              <div>
                  <h1 class="text-base md:text-lg font-black text-[#FFE66D] tracking-wider uppercase">RICO POLLO - PANEL ADMIN</h1>
              </div>
          </div>
          <div class="flex items-center gap-2 flex-wrap">
              ...
              <form action="{{ route('logout') }}" method="POST" class="inline">
                  @csrf
                  <button type="submit" class="btn-outline text-xs font-bold uppercase !py-2 !px-3 border-red-500/40 text-red-400 hover:bg-red-950/30">
    ...
    <div class="glass-card p-6 md:p-8">
      ...
      <form method="post" enctype="multipart/form-data" class="space-y-4">
        ...
        <div>
          ...
          <?php if (!empty($imagenActual) && file_exists(public_path('assets/productos/' . $imagenActual))): ?>
            <div class="mt-4 flex items-center gap-3">
              <img src="{{ asset('assets/productos/' . $imagenActual) }}"
        ...
        <div>
          ...
          <textarea name="descripcion" class="form-input text-sm" rows="3"><?php echo htmlspecialchars($producto['descripcion'] ?? ''); ?></textarea>
        </div>
                ...
                <div class="flex justify-between items-start gap-3">
                  <div class="flex-1 space-y-3">
                    <div class="grid grid-cols-1 gap-3">
                      <div>
                        ...
                        <input type="text" name="variantes[<?php echo $index; ?>][nombre]" value="<?php echo $valNombre; ?>"
                          class="form-input !py-1 text-sm" required />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <?php if (!empty($valImagen) && file_exists(public_path('assets/productos/' . $valImagen))): ?>
                        <div class="mt-2 flex items-center gap-2">
                          <img src="{{ asset('assets/productos/' . $valImagen) }}"
        ...
        <div class="flex items-center justify-between pt-6 border-t border-white/5">
          <a href="{{ route('admin.productos') }}" class="btn-outline text-xs">
